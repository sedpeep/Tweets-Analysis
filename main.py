...
new_hash = ["#ElectricityBills","#blackout",'haqeei azadi', 'depression gov pakistan','gov pakistan inflation','gov pakistan anxiety']
unique_texts = []
seen_texts = set()


for hashtag in new_hash:
    ...
    while True:
        ...
        save_to_excel(list(unique_texts), "tweets_4.xlsx")
